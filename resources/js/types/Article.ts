...
export class Convert {
    public static toArticle(json: string): Article[] {
        return cast(JSON.parse(json), a(r("Article")));
    }

    public static articleToJson(value: Article[]): string {
        return JSON.stringify(uncast(value, a(r("Article"))), null, 2);
    }
}
...
const typeMap: any = {
    Article: o(
        [
            ...
            { json: "url", js: "url", typ: "" },
            { json: "urlToImage", js: "urlToImage", typ: "" },
            { json: "publishedAt", js: "publishedAt", typ: Date },
            { json: "content", js: "content", typ: u(null, "") },
        ],
        false
    ),
    Source: o(
